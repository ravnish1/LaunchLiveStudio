    ...
    items: [
      {
        ...
        plainTextAnswer: "We handle both workflow automation (streamlining internal processes like onboarding, invoicing, or data entry) and marketing automation (lead nurturing, CRM updates). For example, if you run a service business, we might build a system that captures a lead from your website, automatically enriches their data, routes them to the correct salesperson in your CRM, and triggers a personalized welcome email sequence—entirely hands-off."
      },
      {
        ...
        plainTextAnswer: "A Website acts as your high-performance digital storefront, optimized for speed, design, and SEO. An Automated System connects your existing tools to remove manual tasks and data entry. Custom Software is a bespoke web application built from scratch to solve a unique business problem."
      },
      {
        ...
        plainTextAnswer: "Both, depending on what solves your problem most efficiently. If setting up Make or Zapier with your CRM achieves your goal flawlessly, we’ll do that. But if you need a proprietary AI-powered dashboard or a high-performance web app, we build that from the ground up using scalable, enterprise-grade technologies."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        plainTextAnswer: "We work primarily with ambitious startups, established service businesses, and modern brands looking to scale. We have a robust portfolio and detailed case studies available on our /work page that showcase the exact metrics and outcomes we’ve delivered for clients."
      },
      {
        ...
        plainTextAnswer: "Launch Live Studio operates as a lean, elite team of senior developers, designers, and AI specialists. We take on a strictly limited number of clients per quarter to ensure a high-touch, dedicated experience."
      },
      {
        ...
        plainTextAnswer: "Absolutely. After our initial discovery call, if we’re a mutual fit, we are more than happy to provide direct contact information for past and current clients who can speak to their real-world experience working with us."
      },
      {
        ...
        plainTextAnswer: "Our core team consists of seasoned veterans in software engineering, digital marketing, and AI integration. We are an established agency utilizing proven, battle-tested frameworks."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        plainTextAnswer: "1. Discovery & Strategy: We map out your exact needs. 2. Architecture & Design: We create prototypes for your approval. 3. Development: We build the solution in sprints. 4. Testing & QA: Rigorous testing across devices. 5. Launch & Handoff: We deploy the system and train your team."
      },
      {
        ...
        plainTextAnswer: "Most of our high-performance websites and standard automation systems take between 4 to 8 weeks. More complex custom software builds might take 3 months. We focus on rapid, high-quality deployment."
      },
      {
        ...
        plainTextAnswer: "Your heaviest involvement is during the initial Discovery and Design approval phases. Once development begins, we provide weekly asynchronous video or text updates. You won't be dragged into constant meetings."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        plainTextAnswer: "Because every business has different needs, we don't use one-size-fits-all pricing packages. We provide a precise, transparent quote immediately after our initial discovery call so no time is wasted."
      },
      {
        ...
        plainTextAnswer: "We work on a fixed-price, value-based model for clearly defined projects. You know exactly what you’re paying upfront. There are no surprise hourly overages."
      },
      {
        ...
        plainTextAnswer: "There are no hidden costs. Third-party software licenses are billed directly to you so you own your infrastructure 100%. We will estimate these external costs for you upfront."
      },
      {
        ...
        plainTextAnswer: "The initial build is a one-time cost. We do offer optional, ongoing retainer packages for maintenance, SEO, and continuous optimization, but you are not locked into them."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        plainTextAnswer: "We define clear KPIs before writing a single line of code. We build analytics and tracking into every project so you can see the hard data proving your ROI."
      },
      {
        ...
        plainTextAnswer: "We guarantee the technical performance and delivery of the scope. While we cannot guarantee external market factors, our systems are engineered using industry best practices to maximize your success rate."
      },
      {
        ...
        plainTextAnswer: "We mitigate this by working with strict milestones and approval gates. We offer revision rounds at each major stage to ensure the final product aligns exactly with your expectations."
      }
    ]
  },
  {
    ...
    items: [
      {
        ...
        plainTextAnswer: "We do not disappear. Every project includes a 30-day warranty period post-launch to fix any bugs or edge cases at no extra cost. We also provide comprehensive documentation and a handover training session."
      },
      {
        ...
        plainTextAnswer: "Yes, we can absolutely handle it. We build highly scalable systems precisely so they can grow alongside your revenue. If you need new features, pages, or integrations down the line, we are here to build them."
      },
      {
        ...
        plainTextAnswer: "Always. You will have a direct point of contact at Launch Live Studio. We operate on a fast-response SLA for ad-hoc requests to ensure your business keeps running smoothly."
      }
    ]
  }
];
